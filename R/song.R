...
#'
#' @source Baker TM, Wilson DR, Mennill DJ. 2012. Vocal signals predict attack
#' during aggressive interactions in black-capped chickadees. Anim Behav. 84:
#' 965-974.
#'
"chickadees"

#' A duet interaction between a female rufous-and-white wren and her mate.
#'
#' A data set containing the start and end times of each song produced by a
#' duetting pair of rufous-and-white wrens. These data were collected using an
#' 8-channel microphone array designed to passively sample the natural
#' duetting behavior of breeding partners as they move around their territories
#' (Mennill et al. 2006; Mennill & Vehrencamp 2008).
#'
#' @format A data frame with 50 rows and 3 variables
#'
#' @source
